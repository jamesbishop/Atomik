...
// Method used to return the alpha value of the existing image.
- (GLfloat)alpha;

// Adjust the scaling of images using retina enabled devices.
- (void)setRetinaScale:(float)newScale;

// Determine if the graphic is retina or not?
- (BOOL)isRetina;

// Release our memory to prevent memory leaks.
- (void)dealloc;
