						  ...
						  blendAdditive:(BOOL)inBlendAdditive
{
	...
	if (self != nil) {
		...
		imageManager = [ImageManager sharedImageManager];
        textureManager = [TextureManager sharedTextureManager];
		
        texture = [[imageManager getImageWithName:inTextureName] retain];
		
		// Take the parameters which have been passed into this 
        // particle emitter and set the emitters properties
